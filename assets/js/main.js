! function(e) {
	...
	function l() {
		...
		(function() {
			...
			function s(s) {
				s = s.split(",");
				for(var n = 0; n < s.length; n++) t = o + " " + s[n], e(t).val() ? (e(t).removeClass("is-invalid"), a = !0) : (e(t).addClass("is-invalid"), a = !1)
			}
			s('[name="name"],[name="email"],[name="subject"],[name="number"],[name="message"]'), e(i).val() && e(i).val().match(/^([\w-\.]+@([\w-]+\.)+[\w-]{2,4})?$/) ? (e(i).removeClass("is-invalid"), a = !0) : (e(i).addClass("is-invalid"), a = !1);
			return a
		})() && jQuery.ajax({
			url: e(o).attr("action"),
			data: t,
	...
	e(o).on("submit", (function(e) {
			e.preventDefault(), l()
		})), a = ".popup-search-box", s = ".searchClose", n = "show", e(".searchBoxToggler").on("click", (function(t) {
			t.preventDefault(), e(a).addClass(n)
		})), e(a).on("click", (function(t) {
			t.stopPropagation(), e(a).removeClass(n)
		})), e(a).find("form").on("click", (function(t) {
		...
		function(t, a, s, n) {
			...
			e(this).each((function() {
				...
				s = Math.floor(l.height() / 2), n = l.attr(t), o = l.attr(a), i = c(e(o).css("padding-top")), r = c(e(o).css("padding-bottom")), "top-half" === n ? (e(o).css("padding-bottom", r + s + "px"), l.css("margin-top", "-" + s + "px")) : "bottom-half" === n && (e(o).css("padding-top", i + s + "px"), l.css("margin-bottom", "-" + s + "px"))
			}))
		};
	e("[data-sec-pos]").length && e("[data-sec-pos]").imagesLoaded((function() {
		...
		e(this).each((function() {
			var s, n, o, i, r, l, d = e(this);
			s = d.attr(t), n = d.attr(a), o = d.data("margin-top"), i = d.data("margin-bottom"), r = c(e(n).css("padding-top")), l = c(e(n).css("padding-bottom")), "margin-top" === s ? (e(n).css("padding-bottom", l + c(o) + "px"), d.css("margin-top", "-" + c(o) + "px").css({
				position: "relative",
				"z-index": "3"
			})) : "margin-bottom" === s && (e(n).css("padding-top", r + c(i) + "px"), d.css("margin-bottom", "-" + c(i) + "px").css({
				position: "relative",
				"z-index": "3"
			}))
		}))
	...
	e("[data-sec-space]").length && e("[data-sec-space]").imagesLoaded((function() {
		...
		e('[data-bs-toggle="tab"]').on("shown.bs.tab", (function(a) {
			e(t).isotope({
				filter: "*"
			}), e(".filter-menu-active button:first-child").addClass("active").siblings().removeClass("active")
		}))
	})), e(".masonary-active").imagesLoaded((function() {
		if(e(".masonary-active").length > 0) e(".masonary-active").isotope({
			itemSelector: ".filter-item",
			filter: "*",
			masonry: {
				columnWidth: 1
	...
	}, e(".counter-list").length && e(".counter-list").countdown(), e(".date-pick").datetimepicker({
		timepicker: !1,
		datepicker: !0,
		format: "d-m-y",
		step: 10
