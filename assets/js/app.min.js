...
! function(e, t) {
	...
	W.on(document, "click.bs.carousel.data-api", "[data-bs-slide], [data-bs-slide-to]", J.dataApiClickHandler), W.on(window, "load.bs.carousel.data-api", (function() {
		for(var e = Y.find('[data-bs-ride="carousel"]'), t = 0, i = e.length; t < i; t++) J.carouselInterface(e[t], k(e[t], "bs.carousel"))
	})), b((function() {
		var e = y();
		if(e) {
			var t = e.fn[G];
			e.fn[G] = J.jQueryInterface, e.fn[G].Constructor = J, e.fn[G].noConflict = function() {
		...
		fn: function(e) {
			...
			if(!t.modifiersData[n]._skip) {
				for(var o = i.mainAxis, s = void 0 === o || o, r = i.altAxis, a = void 0 === r || r, l = i.fallbackPlacements, d = i.padding, c = i.boundary, u = i.rootBoundary, f = i.altBoundary, h = i.flipVariations, p = void 0 === h || h, m = i.allowedAutoPlacements, g = t.options.placement, v = pe(g), y = l || (v !== g && p ? function(e) {
					...
					var M = ze(E),
						z = [];
					if(s && z.push(A[O] <= 0), a && z.push(A[E] <= 0, A[M] <= 0), z.every((function(e) {
							return e
						}))) {
						T = C, k = !1;
						break
	...
	W.on(window, "load.bs.scrollspy.data-api", (function() {
		...
		if(e) {
			var t = e.fn[Bt];
			e.fn[Bt] = Ht.jQueryInterface, e.fn[Bt].Constructor = Ht, e.fn[Bt].noConflict = function() {
	...
	t.prototype.add = function(e) {
		...
		for(var s in this.handleScroll(), e = {
			...
			for(var a in this.waypoints[s]) {
				var l, d, c, u, f = this.waypoints[s][a],
					h = f.options.offset,
					p = f.triggerPoint,
					m = 0,
					g = null == p;
				f.element !== f.element.window && (m = f.adapter.offset()[r.offsetProp]), "function" == typeof h ? h = h.apply(f) : "string" == typeof h && (h = parseFloat(h), f.options.offset.indexOf("%") > -1 && (h = Math.ceil(r.contextDimension * h / 100))), l = r.contextScroll - r.contextOffset, f.triggerPoint = m + l - h, d = p < r.oldScroll, c = f.triggerPoint >= r.oldScroll, u = !d && !c, !g && (d && c) ? (f.queueTrigger(r.backward), n[f.group.id] = f.group) : (!g && u || g && r.oldScroll >= f.triggerPoint) && (f.queueTrigger(r.forward), n[f.group.id] = f.group)
			}
		}
	...
	e.extend(e.datetimepicker, l), r(), window.getComputedStyle || (window.getComputedStyle = function(e) {
		...
		return r = function(t) {
			var s, r, a, l, C, O, D = e('<div class="xdsoft_datetimepicker xdsoft_noselect"></div>'),
				...
				A = e('<div class="xdsoft_monthpicker"><button type="button" class="xdsoft_prev"></button><button type="button" class="xdsoft_today_button"></button><div class="xdsoft_label xdsoft_month"><span></span><i></i></div><div class="xdsoft_label xdsoft_year"><span></span><i></i></div><button type="button" class="xdsoft_next"></button></div>'),
			...
			S.id && D.attr("id", S.id), S.style && D.attr("style", S.style), S.weeks && D.addClass("xdsoft_showweeks"), S.rtl && D.addClass("xdsoft_rtl"), D.addClass("xdsoft_" + S.theme), D.addClass(S.className), A.find(".xdsoft_month span").after(W), A.find(".xdsoft_year span").after(F), A.find(".xdsoft_month,.xdsoft_year").on("touchstart mousedown.xdsoft", (function(t) {
				var i, n, o = e(this).find(".xdsoft_select").eq(0),
					...
					r = 0,
					a = o.is(":visible");
				for(A.find(".xdsoft_select").hide(), C.currentTime && (s = C.currentTime[e(this).hasClass("xdsoft_month") ? "getMonth" : "getFullYear"]()), o[a ? "hide" : "show"](), i = o.find("div.xdsoft_option"), n = 0; n < i.length && i.eq(n).data("value") !== s; n += 1) r += i[0].offsetHeight;
			...
			A.find(".xdsoft_select").xdsoftScroller(S).on("touchstart mousedown.xdsoft", (function(e) {
				...
				z.xdsoftScroller(S)
			})), D.append(P).append(M), !0 !== S.withoutCopyright && D.append(j), P.append(A).append(E).append(L), S.insideParent ? e(t).parent().append(D) : e(S.parentID).append(D), C = new function() {
				var t = this;
				t.now = function(e) {
					var i, n, o = new Date;
				...
				clearTimeout(s), s = setTimeout((function() {
					...
					m += "</tbody></table>", E.html(m), A.find(".xdsoft_label span").eq(0).text(S.i18n[o].months[C.currentTime.getMonth()]), A.find(".xdsoft_label span").eq(1).text(C.currentTime.getFullYear() + S.yearOffset), L = O = "";
					var P = 0;
					if(!1 !== S.minTime) {
			...
			})), r = 0, E.on("touchend click.xdsoft", "td", (function(i) {
				...
				var i = !0;
				A.find(".xdsoft_month,.xdsoft_year").find(".xdsoft_select").hide(), S.onClose && e.isFunction(S.onClose) && (i = S.onClose.call(D, C.currentTime, D.data("input"), t)), !1 === i || S.opened || S.inline || D.hide(), t.stopPropagation()
			...
			getAjax: function(i) {
				...
				var n = e.extend({
					...
					success: function(n, o, s) {
						...
						x("ParseAjax", r), t.appendContent(e(r.data), A), i.finished = !0, E(), t._setFocus(), setTimeout((function() {
							t.wrap.addClass(p)
...
(_gsScope._gsQueue || (_gsScope._gsQueue = [])).push((function() {
		...
		function h(e, t, i, n, a) {
			var l, d, c, u, h, p, m, g, v, y, b, _, w, x = e.length - 1,
				k = 0,
				T = e[0].a;
			for(l = 0; l < x; l++) d = (h = e[k]).a, c = h.d, u = e[k + 1].d, g = a ? (b = o[l], w = ((_ = s[l]) + b) * t * .25 / (n ? .5 : r[l] || .5), c - ((p = c - (c - d) * (n ? .5 * t : 0 !== b ? w / b : 0)) + (((m = c + (u - c) * (n ? .5 * t : 0 !== _ ? w / _ : 0)) - p) * (3 * b / (b + _) + .5) / 4 || 0))) : c - ((p = c - (c - d) * t * .5) + (m = c + (u - c) * t * .5)) / 2, p += g, m += g, h.c = v = p, h.b = 0 !== l ? T : T = h.a + .6 * (h.c - h.a), h.da = c - d, h.ca = v - d, h.ba = T - d, i ? (y = f(d, T, v, c), e.splice(k, 1, y[0], y[1], y[2], y[3]), k += 4) : k++, T = m;
			(h = e[k]).b = T, h.c = T + .4 * (h.d - T), h.da = h.d - h.a, h.ca = h.c - h.a, h.ba = T - h.a, i && (y = f(h.a, T, h.c, h.d), e.splice(k, 1, y[0], y[1], y[2], y[3]))
		}

		function p(e, t, i, n) {
			var r, a, l, d, c, f, h = [];
			if(n)
				for(a = (e = [n].concat(e)).length; - 1 < --a;) "string" == typeof(f = e[a][t]) && "=" === f.charAt(1) && (e[a][t] = n[t] + Number(f.charAt(0) + f.substr(2)));
		...
		function m(e, t, i, n, l, d) {
			var c, u, f, m, g, v, y, b, _ = {},
				w = [],
				x = d || e[0];
			for(u in l = "string" == typeof l ? "," + l + "," : ",x,y,z,left,top,right,bottom,marginTop,marginLeft,marginRight,marginBottom,paddingLeft,paddingTop,paddingRight,paddingBottom,backgroundPosition,backgroundPosition_y,", null == t && (t = 1), e[0]) w.push(u);
			if(1 < e.length) {
			...
			if(!n) {
				for(c = w.length; - 1 < --c;)
					if(a[u])
						for(v = (f = _[w[c]]).length - 1, m = 0; m < v; m++) g = f[m + 1].da / s[m] + f[m].da / o[m] || 0, r[m] = (r[m] || 0) + g * g;
		...
		_gsScope._gsDefine("TweenMax", ["core.Animation", "core.SimpleTimeline", "TweenLite"], (function(e, t, i) {
		...
		}), !0), n = 180 / Math.PI, o = [], s = [], r = [], a = {}, l = _gsScope._gsDefine.globals, d = _gsScope._gsDefine.plugin({
			propName: "bezier",
			priority: -1,
			version: "1.3.9",
			API: 2,
			...
			init: function(e, t, i) {
				...
				if(this._beziers = "cubic" !== t.type && "quadratic" !== t.type && "soft" !== t.type ? m(l, isNaN(t.curviness) ? 1 : t.curviness, !1, "thruBasic" === t.type, t.correlate, a) : function(e, t, i) {
						...
						for(l = y.length; - 1 < --l;) {
							for(m[f = y[l]] = a = [], h = 0, c = e.length, d = 0; d < c; d++) n = null == i ? e[d][f] : "string" == typeof(p = e[d][f]) && "=" === p.charAt(1) ? i[f] + Number(p.charAt(0) + p.substr(2)) : Number(p), v && 1 < d && d < c - 1 && (a[h++] = (n + a[h - 2]) / 2), a[h++] = n;
							for(c = h - g + 1, d = h = 0; d < c; d += g) n = a[d], o = a[d + 1], s = a[d + 2], r = 2 == g ? 0 : a[d + 3], a[h++] = p = 3 == g ? new u(n, o, s, r) : new u(n, (2 * o + n) / 3, (2 * o + s) / 3, s);
							a.length = h
						}
						return m
			...
			set: function(e) {
				var t, i, o, s, r, a, l, d, c, u, f, h = this._segCount,
					p = this._func,
					m = this._target,
				...
				for(i = 1 - a, o = this._props.length; - 1 < --o;) s = this._props[o], l = (a * a * (r = this._beziers[s][t]).da + 3 * i * (a * r.ca + i * r.ba)) * a + r.a, this._mod[s] && (l = this._mod[s](l, m)), p[s] ? m[s](l) : m[s] = l;
				if(this._autoRotate) {
					var v, y, b, _, w, x, k, T = this._autoRotate;
					for(o = T.length; - 1 < --o;) s = T[o][2], x = T[o][3] || 0, k = !0 === T[o][4] ? 1 : n, r = this._beziers[T[o][0]], v = this._beziers[T[o][1]], r && v && (r = r[t], v = v[t], y = r.a + (r.b - r.a) * a, y += ((_ = r.b + (r.c - r.b) * a) - y) * a, _ += (r.c + (r.d - r.c) * a - _) * a, b = v.a + (v.b - v.a) * a, b += ((w = v.b + (v.c - v.b) * a) - b) * a, w += (v.c + (v.d - v.c) * a - w) * a, l = g ? Math.atan2(w - b, _ - y) * k + x : this._initialRotations[o], this._mod[s] && (l = this._mod[s](l, m)), p[s] ? m[s](l) : m[s] = l)
				}
			}
		}), c = d.prototype, d.bezierThrough = m, d.cubicToQuadratic = f, d._autoCSS = !0, d.quadraticToCubic = function(e, t, i) {
			...
			if(e) {
				...
				t._registerComplexSpecialProp("bezier", {
					parser: function(e, t, s, r, a, l) {
						...
						for(u in t) g[u] = t[u];
						return g.values = m, (a = new o(e, "bezier", 0, 0, f.pt, 2)).data = f, a.plugin = l, a.setRatio = n, 0 === g.autoRotate && (g.autoRotate = !0), !g.autoRotate || g.autoRotate instanceof Array || (c = !0 === g.autoRotate ? 0 : Number(g.autoRotate), g.autoRotate = null != f.end.left ? [
			...
			var T, S, C, O, D, j, P, A, E, M, z = /(?:\-|\.|\b)(\d|\.|e\-)+/g,
				I = /(?:\d|\-\d|\.\d|\-\.\d|\+=\d|\-=\d|\+=.\d|\-=\.\d)+/g,
			...
			var ke = (se._setPluginRatio = function(e) {
				...
				Se = r.parseComplex = function(e, t, i, n, o, s, a, l, d, c) {
					i = i || s || "", "function" == typeof n && (n = n(A, P)), a = new Te(e, t, 0, 0, a, c ? 2 : 1, null, !1, l, i, n), n += "", o && be.test(n + i) && (n = [i, n], r.colorStringFilter(n), i = n[0], n = n[1]);
					var u, f, h, p, m, g, v, y, _, w, x, k, S, C = i.split(", ").join(",").split(" "),
						O = n.split(", ").join(",").split(" "),
						D = C.length,
						j = !1 !== T;
					for(-1 === n.indexOf(",") && -1 === i.indexOf(",") || (O = -1 !== (n + i).indexOf("rgb") || -1 !== (n + i).indexOf("hsl") ? (C = C.join(" ").replace(J, ", ").split(" "), O.join(" ").replace(J, ", ").split(" ")) : (C = C.join(" ").split(",").join(", ").split(" "), O.join(" ").split(",").join(", ").split(" ")), D = C.length), D !== O.length && (D = (C = (s || "").split(" ")).length), a.plugin = d, a.setRatio = c, u = be.lastIndex = 0; u < D; u++)
			...
			function Ee(e) {
				...
				if(f) {
					...
					if(null != n.ox && (b += (h = (n.oxp ? m * n.ox * .01 : n.ox) - m / 2) - (h * a + (p = (n.oyp ? g * n.oy * .01 : n.oy) - g / 2) * l), _ += p - (h * d + p * c)), y += v ? ", Dx=" + ((h = m / 2) - (h * a + (p = g / 2) * l) + b) + ", Dy=" + (p - (h * d + p * c) + _) + ")" : ", sizingMethod='auto expand')", -1 !== t.indexOf("DXImageTransform.Microsoft.Matrix(") ? u.filter = t.replace(Q, y) : u.filter = y + " " + t, 0 !== e && 1 !== e || 1 != a || 0 !== l || 0 !== d || 1 != c || v && -1 === y.indexOf("Dx=0, Dy=0") || B.test(t) && 100 !== parseFloat(RegExp.$1) || -1 === t.indexOf(t.indexOf("Alpha")) && u.removeAttribute("filter"), !v) {
						var w, x, k, T = j < 8 ? 1 : -1;
			...
			var Me, ze, Ie, Le, We, Fe = "scaleX,scaleY,scaleZ,x,y,z,skewX,skewY,rotation,rotationX,rotationY,perspective,xPercent,yPercent".split(","),
				...
				Ge = (We = j || /Android/i.test(re) && !_gsScope.chrome, ie.createElementNS && Ye.appendChild && !We && (ze = Pe("svg", Ye), Le = (Ie = Pe("rect", ze, {
					...
					height: 50,
					x: 100
				})).getBoundingClientRect().width, Ie.style[qe] = "50% 50%", Ie.style[Re] = "scaleX(0.5)", We = Le === Ie.getBoundingClientRect().width && !(O && $e), Ye.removeChild(ze)), We),
				Ue = function(e) {
				...
				Qe = [1, 0, 0, 1, 0, 0],
				Je = function(e, t) {
					var i, n, o, s, r, a, l, d = e._gsTransform || new He,
						c = e.style;
				...
				Ve = se.getTransform = function(e, i, n, o) {
					...
					var s, a, l, d, c, u, f = n && e._gsTransform || new He,
						h = f.scaleX < 0,
					...
					if(f.svg = !(!e.getCTM || !Xe(e)), f.svg && (Ae(e, ue(e, qe, i, !1, "50% 50%") + "", f, e.getAttribute("data-svg-origin")), Me = r.useSVGTransformAttr || Ge), (s = Je(e)) !== Qe) {
						if(16 === s.length) {
							...
							var W = 6 <= s.length,
								...
								B = s[2] || 0,
								q = W ? s[3] : 1;
							f.x = s[4] || 0, f.y = s[5] || 0, l = Math.sqrt(F * F + R * R), d = Math.sqrt(q * q + B * B), c = F || R ? Math.atan2(R, F) * Z : f.rotation || 0, u = B || q ? Math.atan2(B, q) * Z + c : f.skewX || 0, f.scaleX = l, f.scaleY = d, f.rotation = c, f.skewX = u, $e && (f.rotationX = f.rotationY = f.z = 0, f.perspective = m, f.scaleZ = 1), f.svg && (f.x -= f.xOrigin - (f.xOrigin * F + f.yOrigin * B), f.y -= f.yOrigin - (f.xOrigin * R + f.yOrigin * q))
						}
				...
				Ke = se.set3DTransformRatio = se.setTransformRatio = function(e) {
					var t, i, n, o, s, r, a, l, d, c, u, f, h, p, m, g, v, y, b, _, w, x, k, T = this.data,
						...
						R = T.skewY,
						B = T.skewX;
					if(R && (B += R, C += R), !((1 !== e && 0 !== e || "auto" !== F || this.tween._totalTime !== this.tween._totalDuration && this.tween._totalTime) && F || I || W || j || D || 1 !== E) || Me && L || !$e) C || B || L ? (C *= K, x = B * K, k = 1e5, i = Math.cos(C) * P, s = Math.sin(C) * P, n = Math.sin(C - x) * -A, r = Math.cos(C - x) * A, x && "simple" === T.skewType && (t = Math.tan(x - R * K), n *= t = Math.sqrt(1 + t * t), r *= t, R && (t = Math.tan(R * K), i *= t = Math.sqrt(1 + t * t), s *= t)), L && (M += T.xOrigin - (T.xOrigin * i + T.yOrigin * n) + T.xOffset, z += T.yOrigin - (T.xOrigin * s + T.yOrigin * r) + T.yOffset, Me && (T.xPercent || T.yPercent) && (m = this.t.getBBox(), M += .01 * T.xPercent * m.width, z += .01 * T.yPercent * m.height), M < (m = 1e-6) && -m < M && (M = 0), z < m && -m < z && (z = 0)), b = (i * k | 0) / k + "," + (s * k | 0) / k + "," + (n * k | 0) / k + "," + (r * k | 0) / k + "," + M + "," + z + ")", L && Me ? this.t.setAttribute("transform", "matrix(" + b) : S[Re] = (T.xPercent || T.yPercent ? "translate(" + T.xPercent + "%," + T.yPercent + "%) matrix(" : "matrix(") + b) : S[Re] = (T.xPercent || T.yPercent ? "translate(" + T.xPercent + "%," + T.yPercent + "%) matrix(" : "matrix(") + P + ",0,0," + A + "," + M + "," + z + ")";
					else {
						if(O && (P < (m = 1e-4) && -m < P && (P = E = 2e-5), A < m && -m < A && (A = E = 2e-5), !W || T.z || T.rotationX || T.rotationY || (W = 0)), C || B) C *= K, g = i = Math.cos(C), v = s = Math.sin(C), B && (C -= B * K, g = Math.cos(C), v = Math.sin(C), "simple" === T.skewType && (t = Math.tan((B - R) * K), g *= t = Math.sqrt(1 + t * t), v *= t, T.skewY && (t = Math.tan(R * K), i *= t = Math.sqrt(1 + t * t), s *= t))), n = -v, r = g;
						else {
							if(!(j || D || 1 !== E || W || L)) return void(S[Re] = (T.xPercent || T.yPercent ? "translate(" + T.xPercent + "%," + T.yPercent + "%) translate3d(" : "translate3d(") + M + "px," + z + "px," + I + "px)" + (1 !== P || 1 !== A ? " scale(" + P + "," + A + ")" : ""));
							i = r = 1, n = s = 0
						}
						c = 1, o = a = l = d = u = f = 0, h = W ? -1 / W : 0, p = T.zOrigin, m = 1e-6, _ = ",", w = "0", (C = j * K) && (g = Math.cos(C), u = h * (l = -(v = Math.sin(C))), o = i * v, a = s * v, h *= c = g, i *= g, s *= g), (C = D * K) && (t = n * (g = Math.cos(C)) + o * (v = Math.sin(C)), y = r * g + a * v, d = c * v, f = h * v, o = n * -v + o * g, a = r * -v + a * g, c *= g, h *= g, n = t, r = y), 1 !== E && (o *= E, a *= E, c *= E, h *= E), 1 !== A && (n *= A, r *= A, d *= A, f *= A), 1 !== P && (i *= P, s *= P, l *= P, u *= P), (p || L) && (p && (M += o * -p, z += a * -p, I += c * -p + p), L && (M += T.xOrigin - (T.xOrigin * i + T.yOrigin * n) + T.xOffset, z += T.yOrigin - (T.xOrigin * s + T.yOrigin * r) + T.yOffset), M < m && -m < M && (M = w), z < m && -m < z && (z = w), I < m && -m < I && (I = 0)), b = T.xPercent || T.yPercent ? "translate(" + T.xPercent + "%," + T.yPercent + "%) matrix3d(" : "matrix3d(", b += (i < m && -m < i ? w : i) + _ + (s < m && -m < s ? w : s) + _ + (l < m && -m < l ? w : l), b += _ + (u < m && -m < u ? w : u) + _ + (n < m && -m < n ? w : n) + _ + (r < m && -m < r ? w : r), D || j || 1 !== E ? (b += _ + (d < m && -m < d ? w : d) + _ + (f < m && -m < f ? w : f) + _ + (o < m && -m < o ? w : o), b += _ + (a < m && -m < a ? w : a) + _ + (c < m && -m < c ? w : c) + _ + (h < m && -m < h ? w : h) + _) : b += ",0,0,0,0,1,0,", b += M + _ + z + _ + I + _ + (W ? 1 + -I / W : 1) + ")", S[Re] = b
					}
				};
			...
			function et(e) {
			...
			}(d = He.prototype).x = d.y = d.z = d.skewX = d.skewY = d.rotation = d.rotationX = d.rotationY = d.zOrigin = d.xPercent = d.yPercent = d.xOffset = d.yOffset = 0, d.scaleX = d.scaleY = d.scaleZ = 1, De("transform,scale,scaleX,scaleY,scaleZ,x,y,z,rotation,rotationX,rotationY,rotationZ,skewX,skewY,shortRotation,shortRotationX,shortRotationY,shortRotationZ,transformOrigin,svgOrigin,transformPerspective,directionalRotation,parseTransform,force3D,skewType,xPercent,yPercent,smoothOrigin", {
				parser: function(e, t, i, n, s, a, l) {
					...
					return D = "function" == typeof T.transformOrigin ? T.transformOrigin(A, P) : T.transformOrigin, O.svg && (D || T.svgOrigin) && (m = O.xOffset, g = O.yOffset, Ae(e, ge(D), c, T.svgOrigin, T.smoothOrigin), s = xe(O, "xOrigin", (b ? O : c).xOrigin, c.xOrigin, s, C), s = xe(O, "yOrigin", (b ? O : c).yOrigin, c.yOrigin, s, C), m === O.xOffset && g === O.yOffset || (s = xe(O, "xOffset", b ? m : O.xOffset, O.xOffset, s, C), s = xe(O, "yOffset", b ? g : O.yOffset, O.yOffset, s, C)), D = "0px 0px"), (D || $e && f && O.zOrigin) && (Re ? (h = !0, y = qe, D || (D = (D = (ue(e, y, o, !1, "50% 50%") + "").split(" "))[0] + " " + D[1] + " " + O.zOrigin + "px"), D += "", (s = new Te(x, y, 0, 0, s, -1, C)).b = x[y], s.plugin = a, $e ? (u = O.zOrigin, D = D.split(" "), O.zOrigin = (2 < D.length ? parseFloat(D[2]) : u) || 0, s.xs0 = s.e = D[0] + " " + (D[1] || "50%") + " 0px", (s = new Te(O, "zOrigin", 0, 0, s, -1, s.n)).b = u, s.xs0 = s.e = O.zOrigin) : s.xs0 = s.e = D) : ge(D + "", O)), h && (n._transformType = O.svg && Me || !f && 3 !== this._transformType ? 2 : 3), d && (l.scale = d), s
				},
				allowFunc: !0,
				prefix: !0
			}), De("boxShadow", {
			...
			function it(e) {
				if((1 === e || 0 === e) && this.data._totalTime === this.data._totalDuration && "isFromStart" !== this.data.data) {
					...
					if("all" === this.e) o = !(r.cssText = "");
						...
						for(n = (t = this.e.split(" ").join("").split(",")).length; - 1 < --n;) i = t[n], l[i] && (l[i].parse === a ? o = !0 : i = "transformOrigin" === i ? qe : l[i].p), tt(r, i);
	...
	function(e, t) {
		...
		x("Ticker", (function(e, t) {
			var i, o, s, r, a, d = this,
				...
				g = function(e) {
					var t, n, l = P() - A;
					p < l && (c += l - m), A += l, d.time = (A - c) / 1e3, t = d.time - a, (!i || 0 < t || !0 === e) && (d.frame++, a += t + (r <= t ? .004 : r - t), n = !0), !0 !== e && (s = o(g)), n && d.dispatchEvent("tick")
				};
			O.call(d), d.time = d.frame = 0, d.tick = function() {
				...
				null !== s ? d.sleep() : e ? c += -A + (A = P()) : 10 < d.frame && (A = P() - p + 5), o = 0 === i ? l : u && D ? D : function(e) {
		...
		f = E.ticker = new g.Ticker, (u = E.prototype)._dirty = u._gc = u._initted = u._paused = !1, u._totalTime = u._time = 0, u._rawPrevTime = -1, u._next = u._last = u._onUpdate = u._timeline = u.timeline = null, u._paused = !1;
		var M = function() {
		...
		}(u = z.prototype = new E).constructor = z, u.kill()._gc = !1, u._first = u._last = u._recent = null, u._sortChildren = !1, u.add = u.insert = function(e, t, i, n) {
			var o, s;
		...
		}(u = L.prototype = new E).constructor = L, u.kill()._gc = !1, u.ratio = 0, u._firstPT = u._targets = u._overwrittenProps = u._startAt = null, u._notifyPluginsOfEnabled = u._lazy = !1, L.version = "2.1.3", L.defaultEase = u._ease = new T(null, null, 1, 1), L.defaultOverwrite = "auto", L.ticker = f, L.autoSleep = 120, L.lagSmoothing = function(e, t) {
			f.lagSmoothing(e, t)
		...
		K._startTime = f.time, V._startTime = f.frame, K._active = V._active = !0, setTimeout(ee, 1), E._updateRoot = L.render = function() {
			var e, t, i;
		...
		u._init = function() {
			...
			for(r in $[t._gsTweenID] && ee(), this.vars.css || t.style && t !== e && t.nodeType && G.css && !1 !== this.vars.autoCSS && function(e, t) {
					var i, n = {};
					for(i in e) Q[i] || i in t && "transform" !== i && "x" !== i && "y" !== i && "width" !== i && "height" !== i && "className" !== i && "border" !== i || !(!G[i] || G[i] && G[i]._autoCSS) || (n[i] = e[i], delete e[i]);
					e.css = n
			...
			var e = this._time;
			return this._firstPT = this._overwrittenProps = this._startAt = this._onUpdate = null, this._notifyPluginsOfEnabled = this._active = this._lazy = !1, this._propLookup = this._targets ? {} : [], E.prototype.invalidate.call(this), this.vars.immediateRender && (this._time = -v, this.render(e, !1, !1 !== this.vars.lazy)), this
		}, u._enabled = function(e, t) {
					...
					this.revert(), this.lines = [], this.words = [], this.chars = [], t !== i && (this.settings = a(this.settings, t)), r(this.elements, (function(t) {
						(function(t) {
							...
							if(o = h ? d("div") : b(), w.innerHTML = t.innerHTML.replace(/<br\s*\/?>/g, " " + u + " "), s = w.textContent.replace(/\s+/g, " ").trim().split(" ").map((function(e) {
								...
								P = l(t).nodes = t.getElementsByTagName(c), A = t.parentElement, E = t.nextElementSibling, M = e.getComputedStyle(t), z = M.textAlign, y && (O = {
									left: o.offsetLeft,
									top: o.offsetTop,
									width: o.offsetWidth
								...
								})), A.removeChild(t), h && (o = b(), x = I.map((function(e) {
